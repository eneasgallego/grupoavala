...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre Y Apellidos: *:</b></td><td>' . htmlentities($_REQUEST["custom_U369"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Mensaje:</b></td><td>' . htmlentities($_REQUEST["custom_U396"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Teléfono: *:</b></td><td>' . htmlentities($_REQUEST["custom_U404"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Provincia: *:</b></td><td>' . htmlentities($_REQUEST["custom_U411"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Marca y Modelo: *:</b></td><td>' . htmlentities($_REQUEST["custom_U416"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Año de Matriculación: *:</b></td><td>' . htmlentities($_REQUEST["custom_U421"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From:  info@grupoavala.com' . "\r\n" . 'Reply-To: ' . $formEmail .  "\r\n" .'X-Mailer: Adobe Muse 7.0.314 with PHP/' . phpversion() . "\r\n" . 'Content-type: text/html; charset=utf-8' . "\r\n";
	
	$sent = @mail($to, $subject, $message, $headers);
	
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"graciasb.html"}}';
